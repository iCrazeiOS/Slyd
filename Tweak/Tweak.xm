...
static CSScrollView *psv = nil;
static CSMainPageView *sdbmpv = nil;
static CSTodayContentView *sdbtcv = nil;
static CSFixedFooterViewController *sdbffvc = nil;
static CSTeachableMomentsContainerViewController *sdbtmcvc = nil;
static CSViewController *sbdbvc = nil;
static bool preventHome = false;
static bool isOnLockscreen = true;
static bool canUnlock = false;

static CSPasscodeViewController *passController;
...
-(void)aggregateAppearance:(id)arg1 {
    ...
    if (!passController) {
        passController = [[%c(CSPasscodeViewController) alloc] init];
